...
const INGREDIENT_OVERRIDES: Record<string, string> = {
  ...
  // --- Stocks & broths (must beat the generic 'chicken'/'beef'/etc keywords) ---
  ...
  'veggie stock': 'vegetable-stock',
  'veggie broth': 'vegetable-stock',
  'fish stock': 'fish-stock',
  'fish broth': 'fish-stock',
  'seafood stock': 'fish-stock',
  'lamb stock': 'lamb-stock',
  // Anything else with stock/broth/bouillon gets the generic stock carton
  // instead of falling through to a raw-protein keyword (e.g. "pork stock").
  'bouillon': 'stock',
  'broth': 'stock',
  'stock': 'stock',
  'capsicum': 'red-pepper',
...
const BUCKET_BASE = `${process.env.EXPO_PUBLIC_SUPABASE_URL}/storage/v1/object/public/ingredient-images`;
