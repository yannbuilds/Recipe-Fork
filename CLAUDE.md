...
- ⬜ **Phase 3 — Offline + polish:** TanStack Query cache persistence to AsyncStorage (recipes readable in airplane mode), `expo-image` disk caching, more haptics, proper app icon + splash (currently Expo template placeholders).
